...
public class EspejoDTO {
    ...
    public EspejoDTO(Long id, String codigo, LocalDate fechaEdición, String edicion, String ubicacion, String ruc, String razonSocial, String domicilio, String cantidad, String estado, List<String> observacion, User user) {
        this.id = id;
        this.codigo = codigo;
