...
public class EmergencyLights {
    ...
    public EmergencyLights(Long id, String codigo, LocalDate fechaEdición, String edicion, LocalDate date, String ubicacion, String senalizacion, String direcionado, String acceso, String conectado, String funciona, String limpio, String observacion, String conclusion, User user) {
        this.id = id;
        this.codigo = codigo;
